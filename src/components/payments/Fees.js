      ...
      <div className="card shadow mb-4">
        ...
        <div className="card-body">
          ...
          <table className="table table-bordered" id="dataTable" cellSpacing="0">
            <thead>
              <tr>
                <th>Fee</th><th className='d-none d-md-block' >Amount</th><th>Amount Paid</th><th>Outstanding</th><th>Remark</th>
              </tr>

            </thead>
            <tbody>
              <tr>
                <td>Registration Fee</td><td className='d-none d-md-block'><span>N</span>{sectionFees?.registration}</td><td><span>N</span> {fees?.registration}</td><td>{fees?.registrationRemark === "Incomplete Payment" ? (sectionFees?.registration - fees?.registration) : 0}</td><td>{fees?.registrationRemark}</td>
              </tr>
