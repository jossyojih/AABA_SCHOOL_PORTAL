...
import ReportSheetSummary from '../result/ReportSheetSummary'
import Loader from 'react-loader-spinner'

function SecConfirmScores({scores,setScores,total,setTotal,average,setAverage,nextStep,prevStep,setStep,data, setData,saveResult,grade,setGrade,scale,setScale,isLoading}) {
  ...
  return (
    <div className='computeResult'>
      ...
      <table className="table table-bordered"  id="dataTable" width="80%" cellSpacing="0">    
          <thead>
              <tr>
                <th>Subject</th><th>Test</th><th>exam</th><th>average</th><th>Grade</th><th>Remarks</th>
              </tr>
...
export default SecConfirmScores
