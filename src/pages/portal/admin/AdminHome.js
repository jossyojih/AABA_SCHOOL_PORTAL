...
// import StaffDailyAttendanceCard from '../Staff/StaffDailyAttendanceCard';
// import LowerGradeAttendanceCard from '../Student/StudentAttendanceRegister/LowerGradeAttendanceCard';
// import UpperGradeAttendanceCard from '../Student/StudentAttendanceRegister/UpperGradeAttendanceCard';
  ...
  return (
    ...
    <div className="container-fluid">
      ...
      <div className="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 className="h3 mb-0 text-gray-800">School Statistics</h1>
      </div>
      ...
      <div className="row">
        ...
        <SchoolCalendarCard />
        {/* <StaffDailyAttendanceCard />
        <LowerGradeAttendanceCard />
        <UpperGradeAttendanceCard /> */}
       {/*  
